...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        // NO cancelamos, dejamos que el formulario envíe los datos normalmente
        // e.preventDefault();  <-- ¡NO usar esto!
        ...
        if (email === "" || password === "") {
            ...
            e.preventDefault(); // solo cancelamos si FALTAN datos
        }
    });
